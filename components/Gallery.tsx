const tiles = [
  {
    ...
    sub: 'Low-maintenance outdoor areas',
    icon: (
  ...
  },
  {
    ...
    sub: 'Driveways, patios and paths',
    icon: (
      <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    ring: 'ring-green-500',
    iconColor: 'text-amber-300',
    name: 'Planting and Cleanup',
    sub: 'Fresh, clean outdoor spaces',
    icon: (
      <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.2} d="M12 3v18M8 7c-2 0-4 2-4 4 4 0 6-2 8-4M16 7c2 0 4 2 4 4-4 0-6-2-8-4" />
      </svg>
    ),
  },
  {
    ...
    iconColor: 'text-white',
    name: 'And More',
    sub: 'Custom landscape solutions',
    icon: (
      <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
